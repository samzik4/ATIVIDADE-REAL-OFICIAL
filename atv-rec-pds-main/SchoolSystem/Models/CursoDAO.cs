    ...
    class CursoDAO
    {
        ...
        public void Insert(Curso curso)
        {
            try
            {
                ...
                comando.CommandText = "Insert into curso values (null, @nome, @cargaHoraria, @turno, @descricao, @id_esc)";
                ...
                comando.Parameters.AddWithValue("@id_esc", curso.Escola.Id);
                ...
                if(resultado == 0)
                {
                    throw new Exception("Ocorrram erros ao salvar");
                }
            }
            catch (Exception ex)
            {
